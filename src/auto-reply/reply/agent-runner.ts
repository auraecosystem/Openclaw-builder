...
export async function runReplyAgent(params: {
  ...
  try {
    ...
    // The Discord message-tool-only guard below relies on this drain: committed
    // message.send evidence must settle before we decide whether a visible reply is missing.
