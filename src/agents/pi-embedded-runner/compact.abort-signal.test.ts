...
// Stub the inner once-fn dependencies. compactEmbeddedPiSessionDirectOnce isn't
...
vi.mock("./compact.queued.js", () => ({ compactEmbeddedPiSession: vi.fn() }));
...
describe("compactEmbeddedPiSessionDirect — abortSignal threading (regression for openclaw/openclaw#62682)", () => {
  beforeEach(() => {
    runMock.mockClear();
  });
