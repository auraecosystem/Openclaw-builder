...
function hasScopedExternalCliOverlay(options: ResolvedExternalCliOverlayOptions): boolean {
  return options.externalCliProviderIds !== undefined || options.externalCliProfileIds !== undefined;
}
...
function mergeRuntimeExternalProfileReferences(params: {
  ...
  merged.runtimeExternalProfileIds = [...mergedRuntimeExternalProfileIds].toSorted();
...
function mergeRuntimeExternalProfileState(params: {
  ...
  merged.runtimeExternalProfileIds = [...mergedRuntimeProfileIds].toSorted();
  merged.runtimeExternalProfileIdsAuthoritative =
    params.existing.runtimeExternalProfileIdsAuthoritative === true ? true : undefined;
  return merged;
}
