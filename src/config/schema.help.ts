...
export const FIELD_HELP: Record<string, string> = {
  ...
  "agents.defaults.compaction.maxActiveTranscriptTokens":
    'Codex app-server native-thread token reuse guard. When truncateAfterCompaction is enabled, OpenClaw starts a fresh thread if the bound native transcript reaches this many tokens (default: 70000). Set a larger value such as "120k" for trusted long-running Codex sessions, or 0 to disable this proactive token guard while preserving semantic binding invalidation and byte limits.',
