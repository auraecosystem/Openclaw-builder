...
export function resolveVllmQwenThinkingFormatFromParams(
  params?: Record<string, unknown> | null,
): VllmQwenThinkingFormat | undefined {
  return normalizeVllmQwenThinkingFormat(
    params?.qwenThinkingFormat ?? params?.qwen_thinking_format,
  );
}
...
export function resolveThinkingProfile(
  ...
  const qwenFormat =
    resolveVllmQwenThinkingFormatFromParams(ctx.params) ??
