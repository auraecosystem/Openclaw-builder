...
export const BrowserToolSchema = Type.Object({
  ...
  sources: Type.Optional(Type.Boolean()),
  insightSetId: Type.Optional(Type.String()),
  insightName: Type.Optional(Type.String()),
  outputDirPath: Type.Optional(Type.String()),
  ...
  msgid: Type.Optional(Type.Number()),
  reqid: Type.Optional(Type.Number()),
  requestFilePath: Type.Optional(Type.String()),
  responseFilePath: Type.Optional(Type.String()),
  ...
  reducedMotion: Type.Optional(Type.String()),
