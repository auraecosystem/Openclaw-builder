...
| `startupTimeoutMs`                            | `120000`                                               | Maximum time to wait for the app-server child process to start, separate from the per-turn timeout. A short ceiling here lets local startup failures fail fast instead of holding the agent lane for the full turn budget.                                                                                                                            |
