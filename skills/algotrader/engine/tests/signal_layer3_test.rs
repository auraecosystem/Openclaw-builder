...
use algotrader_engine::signals::execution_signals;
use algotrader_engine::signals::execution_signals::ExecutionSignals;
...
fn execution_bocpd_exit_fires_above_threshold() {
    ...
    let es = execution_signals::execution_signals(100.0, 0.01, 0.8, 1.5, 2.0, None, &params);
...
fn execution_bocpd_no_exit_below_threshold() {
    ...
    let es = execution_signals::execution_signals(100.0, 0.01, 0.3, 1.5, 2.0, None, &params);
...
fn execution_bocpd_no_exit_at_threshold() {
    let params = SignalParams::default();
    let es = execution_signals::execution_signals(100.0, 0.01, 0.7, 1.5, 2.0, None, &params);
...
fn execution_vmd_trigger_fires_above_threshold() {
    ...
    let es = execution_signals::execution_signals(100.0, 0.01, 0.1, 3.0, 2.0, None, &params);
...
fn execution_vmd_trigger_no_fire_below_threshold() {
    let params = SignalParams::default();
    let es = execution_signals::execution_signals(100.0, 0.01, 0.1, 1.5, 2.0, None, &params);
...
fn execution_vmd_trigger_no_fire_at_threshold() {
    let params = SignalParams::default();
    let es = execution_signals::execution_signals(100.0, 0.01, 0.1, 2.0, 2.0, None, &params);
...
fn execution_kalman_stop_basic() {
    ...
    let es = execution_signals::execution_signals(100.0, 0.0, 0.1, 1.0, 5.0, None, &params);
...
fn execution_kalman_stop_nan_atr() {
    let params = SignalParams::default();
    let es = execution_signals::execution_signals(100.0, 0.01, 0.1, 1.0, f32::NAN, None, &params);
...
fn execution_kalman_stop_nan_level() {
    let params = SignalParams::default();
    let es = execution_signals::execution_signals(f32::NAN, 0.01, 0.1, 1.0, 2.0, None, &params);
...
fn execution_kalman_stop_positive_trend_wider() {
    ...
    let es_pos = execution_signals::execution_signals(100.0, 0.005, 0.1, 1.0, 2.0, None, &params);
    let es_neg = execution_signals::execution_signals(100.0, -0.005, 0.1, 1.0, 2.0, None, &params);
    assert!(
...
fn execution_conformal_scale_default_when_none() {
    let params = SignalParams::default();
    let es = execution_signals::execution_signals(100.0, 0.01, 0.1, 1.0, 2.0, None, &params);
    assert!(
        (es.conformal_size_scale - 1.0).abs() < 1e-6,
...
fn execution_conformal_narrow_scales_up() {
    let params = SignalParams::default();
    let es = execution_signals::execution_signals(100.0, 0.01, 0.1, 1.0, 2.0, Some(0.5), &params);
    assert!(
...
fn execution_conformal_wide_scales_down() {
    let params = SignalParams::default();
    let es = execution_signals::execution_signals(100.0, 0.01, 0.1, 1.0, 2.0, Some(100.0), &params);
    assert!(
        es.conformal_size_scale < 1.0,
...
fn execution_conformal_zero_width_defaults() {
    let params = SignalParams::default();
    let es = execution_signals::execution_signals(100.0, 0.01, 0.1, 1.0, 2.0, Some(0.0), &params);
    assert!(
        (es.conformal_size_scale - 1.0).abs() < 1e-6,
...
fn execution_conformal_nan_width_defaults() {
    let params = SignalParams::default();
    let es = execution_signals::execution_signals(100.0, 0.01, 0.1, 1.0, 2.0, Some(f32::NAN), &params);
    assert!(
        (es.conformal_size_scale - 1.0).abs() < 1e-6,
...
fn execution_conformal_scale_capped_high() {
    ...
    let es = execution_signals::execution_signals(100.0, 0.01, 0.1, 1.0, 2.0, Some(0.01), &params);
    assert!(
...
fn execution_conformal_scale_floored() {
    ...
    let es = execution_signals::execution_signals(100.0, 0.01, 0.1, 1.0, 2.0, Some(1000.0), &params);
    assert!(
...
fn execution_all_signals_fire_simultaneously() {
    let params = SignalParams::default();
    let es = execution_signals::execution_signals(
        100.0,   // kalman_level
