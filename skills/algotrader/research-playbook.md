...
- "VCP patterns with 3+ contractions should outperform 2-contraction VCPs" (from `/Users/ad/work/trading-tools/knowledge_base/10-Entities/Setups/Qullamaggie Continuation Breakout.md`)
...
Hypothesize about new filters, exit rules, or entry timing changes. These require careful reasoning about _why_ they should work (behavioral or structural mechanism):
