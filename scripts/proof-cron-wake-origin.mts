...
// guard) into the patched cron service wake() (timer.ts) with deps wired to LOG
...
import { wake as cronTimerWake } from "../src/cron/service/timer.js";
